    ...
    html.Div([
        ...
        dbc.Tabs([
            ...
            dbc.Tab([
                html.Ul([
                    html.Br(),
                    html.Li('Book title: Interative Dashboards and and Data Apps with Plotly and Dash'),
                    html.Li(['GitHub repo: ',
...
indicators_dashboard = html.Div([
    ...
    dbc.Row([
        ...
        ], md=12, lg=5 #, style={'width': '50%','display':'inline-block'}
        ),
        dbc.Col([
            dbc.Label('Countries'),
    ...
    dbc.Row([
        dbc.Col(lg=1),
        dbc.Col([
            html.H2('Income Share Distribution',
                style={'textAlign': 'center'}),
            html.Br(),
            dbc.Label('Country'),
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            ], md=12, lg=2), #, style={'width': '30%','display':'inline-block'}
        dbc.Col([
            html.Br(),
            ...
            ], md=12, lg=5), #, style={'width': '70%','display':'inline-block'}
        ]),
...
@app.callback(Output('country_page_country_dropdown', 'value'),
              Input('location', 'pathname'))
...
def display_generic_map_chart(indicator):
    ...
    if series_df.empty:
        ...
        * **Unit Measure** {series_df['Unit of measure'].fillna('count').values[0]}
...
def clustered_map(n_clicks, year, n_clusters, indicators):
    if (not n_clicks) and (not indicators):
        raise PreventUpdate
